...
export const storeNotificationOrderCancelledByAdmin = async (buyerEmail, order, reason) => {
    ...
    <body>
        <div class="container">
            <div class="header">
                ...
                <div>Your Elteema order was cancelled by admin!</div>
            </div>
            
            <div class="content">
                <div class="greeting">Hi ${capitalize(buyerName)}</div>
                
                <div class="message">
                    <p>We have cancelled your store order with id: ${order?._id}. 
                    ...
                    <p><span class='product-info'>Buyer Contact Number</span>: ${order?.storePhone}</p>
    ...
    try {
        const response = await sendEmail(buyerEmail, subject, emailBody);
        return response;
    } catch (error) {
